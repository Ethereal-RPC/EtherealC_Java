package Client.Abstract;

import Core.Model.ClientRequestModel;
import Core.Model.ClientResponseModel;
import Core.Model.ServerRequestModel;
import Client.Delegate.ClientRequestModelSerializeDelegate;
import Client.Delegate.ClientResponseModelDeserializeDelegate;
import Client.Delegate.ServerRequestModelDeserializeDelegate;
import Utils.Utils;
